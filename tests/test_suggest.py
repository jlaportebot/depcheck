...
class TestSuggestCLI:
    ...
    @patch("depcheck.suggest.suggest_alternatives")
    def test_suggest_json_output(self, mock_suggest: MagicMock, tmp_path: Path) -> None:
        from click.testing import CliRunner
    ...
    @patch("depcheck.suggest.suggest_alternatives")
    def test_suggest_table_output(self, mock_suggest: MagicMock, tmp_path: Path) -> None:
        from click.testing import CliRunner
